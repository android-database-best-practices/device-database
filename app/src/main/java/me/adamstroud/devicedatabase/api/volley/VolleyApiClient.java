...
/**
 * The Volley web API client.
 *
 * @author Adam Stroud &#60;<a href="mailto:adam.stroud@gmail.com">adam.stroud@gmail.com</a>&#62;
 */
public class VolleyApiClient {
    private static VolleyApiClient instance;

    private RequestQueue requestQueue;

    public static synchronized VolleyApiClient getInstance(Context ctx) {
        if (instance == null) {
            instance = new VolleyApiClient(ctx);
        }
